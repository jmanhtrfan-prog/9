    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 50) {
                ...
                Text("المفتت قماش من الحرير بعدة ألوان ومن هذا القماش، يتم اتخاذ قطع مستطيلة متعددة الألوان، توضع في أكمام الثوب، المسمّى بالمتفّت \"المجزّع\" وقد تُزيَّن أكمام الدراعة \"المِقْطَع\" بقطع الحرير تلك")
